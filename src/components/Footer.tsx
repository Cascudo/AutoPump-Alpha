        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
          ...
          <div className="lg:col-span-1 w-full overflow-hidden">
            <div className="flex items-center space-x-3 mb-6 overflow-hidden">
              <div className="w-12 h-12 bg-gradient-to-br from-teal-400 via-cyan-400 to-emerald-400 rounded-xl flex items-center justify-center font-bold text-xl text-black shadow-lg flex-shrink-0">
                α
              </div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 break-words">
              Community-driven for a healthier DeFi ecosystem. Trade • Reward • Burn.
            </p>
          ...
          <div className="w-full overflow-hidden">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-teal-400 text-sm transition-colors block truncate">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/rewards" className="text-gray-400 hover:text-teal-400 text-sm transition-colors block truncate">
                  Rewards
                </Link>
              </li>
              <li>
                <Link href="/burns" className="text-gray-400 hover:text-teal-400 text-sm transition-colors block truncate">
                  Token Burns
                </Link>
              </li>
              <li>
                <Link href="/leaderboard" className="text-gray-400 hover:text-teal-400 text-sm transition-colors block truncate">
                  Leaderboard
                </Link>
              </li>
              <li>
                <Link href="/vip" className="text-gray-400 hover:text-teal-400 text-sm transition-colors block truncate">
                  VIP Club
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  ...
                  className="text-gray-400 hover:text-teal-400 text-sm transition-colors flex items-center overflow-hidden group"
                >
                  ...
                  <span className="truncate">Pump.fun</span>
                </a>
              </li>
              <li>
                <a 
                  href="https://x.com/AutopumpAlpha" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-gray-400 hover:text-teal-400 text-sm transition-colors flex items-center overflow-hidden group"
                >
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-teal-400 text-sm transition-colors flex items-center overflow-hidden">
