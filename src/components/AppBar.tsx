            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-3 hover:scale-105 transition-transform">
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-400 via-cyan-400 to-emerald-400 rounded-xl flex items-center justify-center font-bold text-2xl text-black shadow-lg">
                    α
                  </div>
          ...
          {isNavOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 border-t border-gray-700">
                ...
                <Link href="/leaderboard" className="text-gray-300 hover:text-teal-400 block px-3 py-2 text-base font-medium">
                  Leaderboard
                </Link>
